...
entity frodo_decaps_mup_ram is 
    generic(
...
architecture rtl of frodo_decaps_mup_ram is 
...
architecture arch of frodo_decaps_mup is
    component frodo_decaps_mup_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    frodo_decaps_mup_ram_U :  component frodo_decaps_mup_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
