...
architecture behav of sample is 
    ...
    signal sign_fu_125_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal sign_reg_222 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln48_fu_205_p1 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    muestra_1_fu_215_p3 <= 
        muestra_fu_209_p2 when (sign_reg_222(0) = '1') else 
        zext_ln48_fu_205_p1;
    muestra_fu_209_p2 <= std_logic_vector(unsigned(ap_const_lv5_0) - unsigned(zext_ln48_fu_205_p1));
    prnd_fu_115_p4 <= s(15 downto 1);
    sign_fu_125_p1 <= s(1 - 1 downto 0);
    zext_ln42_cast_fu_201_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(icmp_ln42_fu_195_p2),4));
    zext_ln48_fu_205_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(muestra_11_reg_64),5));
end behav;
